...
INSERT INTO "new_Phone" ("createdAt", "id", "number", "updateAt", "userId") SELECT "createdAt", "id", "number", "updateAt", "userId" FROM "Phone";
DROP TABLE "Phone";
...
INSERT INTO "new_QRCode" ("carPlate", "code", "createdAt", "id", "imageUrl", "ownerId", "status", "updateAt") SELECT "carPlate", "code", "createdAt", "id", "imageUrl", "ownerId", "status", "updateAt" FROM "QRCode";
DROP TABLE "QRCode";
...
INSERT INTO "new_QRCodeBinding" ("createdAt", "id", "isOwner", "qrcodeId", "updateAt", "userId") SELECT "createdAt", "id", "isOwner", "qrcodeId", "updateAt", "userId" FROM "QRCodeBinding";
